...
output_folder_start = 'F:/Germany_2022/TU Illmenau/hiwi/DataSets/histology/Stack_transform_middle_to_start/previous'
output_folder_end = 'F:/Germany_2022/TU Illmenau/hiwi/DataSets/histology/Stack_transform_middle_to_end/previous'
output_folder_start_first = 'F:/Germany_2022/TU Illmenau/hiwi/DataSets/histology/Stack_transform_middle_to_start/first'
output_folder_end_first = 'F:/Germany_2022/TU Illmenau/hiwi/DataSets/histology/Stack_transform_middle_to_start/first'
...
img_stack_start = [process_slide(f, level=5) for f in ndpi_files[:middle_index+1][::-1]]  # Reverse to start from middle to first
...
registered_start_first = sr.register_transform_stack(img_stack_start, reference='first')[::-1]  # Reverse back after registration
